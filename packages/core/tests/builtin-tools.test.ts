...
describe("built-in tool style resolution", () => {
  it("V571 preserves a persisted binding before Settings or Model preferences", () => {
    expect(
  ...
  it("V571 resolves concrete Settings, explicit Model metadata, then Codex fallback", () => {
    expect(
      resolveBuiltinToolStyle({
        configuredStyle: "kimi_code",
        modelPreferredStyle: "claude_code",
